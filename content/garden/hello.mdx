...
I'd find it extremely helpful to hear any targeted feedback you might have via the note-linked comment threads. If possible, please pose leading questions which I can then use to sketch out new branches from the note you're commenting on. **Best viewed on desktop.**
